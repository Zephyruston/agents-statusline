...
cd agents-statusline/claude
```

> The `claude/` directory holds this statusline; step 2 must run from inside it.
...
Open Claude Code in the `claude/` directory of the cloned repo and type:
